...
{
    public class DateTimeGenControl : GControl
    {
        private void AddXaml(GRenderOutput renderContext)
        {
            ...
            renderContext.Xaml.AppendLine();
            renderContext.Xaml.AppendFormat(Resources_WPFGenerator.T017, BindedProperty.Name, renderContext.rowNum, renderContext.colNum + 1, renderContext.tabIndex);
        ...
        private void AddViewModel(GRenderOutput renderContext)
        {
            ...
            renderContext.ViewModel.AppendFormat(Resources_WPFGenerator.T018, fieldName, propName);
